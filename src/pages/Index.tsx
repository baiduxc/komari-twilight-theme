...
export default function Index() {
  ...
  const onlineCount=mapNodes.filter(node=>node.uuid.startsWith("demo-")||online.has(node.uuid)).length; const background=publicInfo?.theme_settings?.backgroundImageUrl||"/twilight-earth.jpg";
